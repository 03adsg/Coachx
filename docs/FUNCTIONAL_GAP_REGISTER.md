...
| FEEDBACK-001 | P3 | Feedback | Stale `Signed out` / `Onboarding complete` toasts can remain visible after session changes. | Distracting, misleading feedback state. | Clear the feedback queue on auth and route transitions. |
